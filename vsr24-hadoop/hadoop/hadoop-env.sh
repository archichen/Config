...
# memory size.
#export HADOOP_HEAPSIZE_MAX=204800
...
# export HADOOP_OPTIONAL_TOOLS="hadoop-aliyun,hadoop-azure-datalake,hadoop-azure,hadoop-kafka,hadoop-openstack"
...
#export HADOOP_LOG_DIR=/mnt/sdb/hadoop-logs
...
#
# a) Set JMX options
export HDFS_NAMENODE_OPTS="-Xmx32768m -Dcom.sun.management.jmxremote=true -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.port=1026"
#
